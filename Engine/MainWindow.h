...
class HWNDKey
{
	friend Graphics::Graphics( HWNDKey&,const Config& );
public:
...
public:
	MainWindow( HINSTANCE hInst,wchar_t* pArgs,const Config& config );
...
private:
	...
	std::wstring args;
	ExitMode exitMode = ExitMode::Invalid;
};